...
<div className="image-heading">Product / API - Product Details Page - Guide View</div>

![Product / API - Product Details Page - Specifications View](/images/articles/images/pg-pdp-2.png)

<div className="image-heading">Product / API - Product Details Page - Specifications View</div>
